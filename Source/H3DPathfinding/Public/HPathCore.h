...
public:
    ...
    void FindPath(UWorld* WorldRef,AHVolume3D* VolumeRef,FS_PathResult* Result,FVector Start,FVector End,PathResultDelegate Delegate,bool bIsWalking,float CharacterRadius,float CharacterHalfHeight,AActor* OwnerRef, bool bPathAdjusted);
...
private:
    ...
    FVector AdjustPath(UWorld* WorldRef,const FVector& EndPosition,AHVolume3D* VolumeRef,bool bIsWalking,float CharacterRadius,float CharacterHalfHeight,AActor* OwnerRef);
};
